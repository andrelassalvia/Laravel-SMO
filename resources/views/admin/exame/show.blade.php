...
<div class="conteudo">
  ...
  <form action="{{route('exames.destroy',[$exame->id])}}" class="form-control form--create" method="get">
    <div class="form1">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="form-group d-flex col-sm-11">
          ...
          <div class=" col-sm-10 ">
            <input placeholder="" type="text" name="nome" class="form-control" value="{{$exame->nome}}">
          </div>
        </div>
